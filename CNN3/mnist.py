...
def train_images():
    ...
    """
    return download_and_parse_mnist_file(Path.cwd() / 'data/train-images-idx3-ubyte')
...
def test_images():
    ...
    test_images : numpy.ndarray
        ...
        columns of the image
    """
    return download_and_parse_mnist_file(Path.cwd() / 'data/t10k-images-idx3-ubyte')
...
def train_labels():
    ...
    """
    return download_and_parse_mnist_file(Path.cwd() / 'data/train-labels-idx1-ubyte')
...
def test_labels():
    ...
    test_labels : numpy.ndarray
        Numpy array with the labels 0 to 9 in the train MNIST database.
    """
    return download_and_parse_mnist_file(Path.cwd() / 'data/t10k-labels-idx1-ubyte')